document.write("<iframe id='mainDisplay' src='#' style='width:90%; height:50%'></iframe><P><textarea id='certInput' style='width:800px; height:100px;' placeholder='-----BEGIN CERTIFICATE-----'></textarea></P><H3><a href='javascript:void(0)' id='cert'>Get Certspotter Entry</a>　<a href='javascript:void(0)' id='clearDisplay'>Clear Display</a></H3><H3><input id='domain' placeholder='www.example.com' /> <a id='certs' href='javascript:void(0)'>certs</a>：<span id='timestampDisplay'></span></H3><H3><form method='GET' action='ct/v1/get-proof-by-hash'><input id='hash' name='hash' placeholder='hash' /> <input id='treeSize' name='tree_size' placeholder='tree_size' /> <a id='getSTH' href='javascript:void(0)'>get-sth</a> <input type='submit' id='getProofByHash' name='' value='get-proof-by-hash' /></form></H3><H3><input id='startindex' placeholder='start(entry-and-proof)' /> <input id='endindex' placeholder='end' /> <a id='getEntries' href='javascript:void(0)'>get-entries</a> <a id='getEntryProof' href='javascript:void(0)'>get-entry-and-proof</a></H3>");
			...
			for(i=0;i<responseData.length;i++){
				...
				obj.onclick = function(){
					...
					for(j=0;j<basedata.length;j++){
						...
						a = a.replace('VYHUwhaQNgFK6gubVzxT8MDkOHhwJQgXL6OqHQcT0ww=','Comodo Sabre');
						a = a.replace('b1N2rDHwMRnYmQCkURX/dxUcEdkCwQApBo2yCJo32RM=','Comodo Mammoth');
